...
if($_SESSION["class"]!=12||$_SESSION["str"]!='COMMERCE'){
...
<body>
	...
	<table align="center" border="1">
        ...
        <tr>
            ...
            <td align="center"><select id="sub1"><option>ENGLISH(CORE)/CSSA07</option></select>
            </td>
        </tr>
        <tr>
        	<td align="center">Subject 2</td>
            <td align="center"><select id="sub2"><option>BUSSINESS STUDIES/CSSC01</option></select>
            </td>
        </tr>
        <tr>
        	<td align="center">Subject 3</td>
            <td align="center"><select id="sub3"><option>ACCOUNTANCY/CSSC02</option></select>
            </td>
        </tr>
        <tr>
        	<td align="center">Subject 4</td>
            <td align="center"><select id="sub4"><option>ECONOMICS/CSSA01</option></select>
            </td>
        </tr>
        <tr>
            ...
            <td align="center"><select id="sub5">
                                ...
                                <option>MARKETING AND SALESMANSHIP/CSSC03</option>
