...
function NewPage($pdf)
{
	...
	$pdf->Cell(320,8,"","",0,'C');$pdf->Cell(80,8,"XII (ARTS)","",1,'C');
	$pdf->Cell(0,2,"","",1,'C');
...
function BottomPageArts($pdf)
{
	...
	$pdf->Cell($height1,$width,"CSSA14 MULTIMEDIA AND WEB MMT","LRTB",0);$pdf->Cell($height1,$width,"CSSS03 MATHEMATICS MAT","LRTB",0);$pdf->SetFont('Arial','',10);$pdf->Cell(200,$width,"Date Of Issue: ".date('d-m-Y'),"",1,'R');
